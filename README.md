...
O arquivo server.js deste repositório tem como objetivo evitar o conflito de portas com o Grafana na porta http://localhost:3030 e incluirá as dependências da biblioteca prom-client para a visualização das métricas no Prometheus.
